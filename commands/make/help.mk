define ASCIBOSSJHBUILD
  ____  __ __  ____   __ __  ____  _      ___           ____  __ __   ____   ___   ____   ____    ___    __ ______
 |    ||  |  ||    \ |  |  ||    || |    |   \         |    \|  |  | /    | /   \ |    \ |    |  /  _]  /  ]      |
 |__  ||  |  ||  o  )|  |  | |  | | |    |    \  _____ |  o  )  |  ||   __||     ||  o  )|__  | /  [_  /  /|      |
 __|  ||  _  ||     ||  |  | |  | | |___ |  D  ||     ||   _/|  ~  ||  |  ||  O  ||     |__|  ||    _]/  / |_|  |_|
/  |  ||  |  ||  O  ||  :  | |  | |     ||     ||_____||  |  |___, ||  |_ ||     ||  O  /  |  ||   [_/   \_  |  |
\  `  ||  |  ||     ||     | |  | |     ||     |       |  |  |     ||     ||     ||     \  `  ||     \     | |  |
 \____||__|__||_____| \__,_||____||_____||_____|       |__|  |____/ |___,_| \___/ |_____|\____||_____|\____| |__|

============BOSS-DOCKER-JHBUILD-PYGOBJECT3============
endef

export ASCIBOSSJHBUILD
...
help:
	@printf "\033[1m$$ASCIBOSSJHBUILD $$NC\n"
	@printf "\033[21m\n"
	...
	@printf "$$GREEN make dev-up$$NC                       docker-compose up -d for all boss-docker-jhbuild-pygobject3 supporting services\n"
	@printf "$$GREEN make dev-down$$NC                     docker-compose stop/rm all boss-docker-jhbuild-pygobject3 supporting services\n"
	...
	@printf "  ... docker tag bossjones/boss-docker-jhbuild-pygobject3:\$$sha bossjones/boss-docker-jhbuild-pygobject3:latest\n"
	@printf "\n"
	@printf "$ make TAG=foo container\n"
	@printf "  ... docker tag bossjones/boss-docker-jhbuild-pygobject3:\$$sha bossjones/boss-docker-jhbuild-pygobject3:foo\n"
	@printf "\n"
	@printf "$ make TAG=@branch container\n"
	@printf "  ... docker tag bossjones/boss-docker-jhbuild-pygobject3:\$$sha bossjones/boss-docker-jhbuild-pygobject3:customize_image_tag\n"
	@printf "$$NC\n"
